/**
 * Interface for dp_Sub_Page_View_Rules
* Table: dp_Sub_Page_View_Rules
 * Access Level: ReadWriteAssignDelete
 * Special Permissions: FileAttach, DataExport
 * Generated from column metadata
 */
export interface DpSubPageViewRules {
...
export type DpSubPageViewRulesRecord = DpSubPageViewRules;
