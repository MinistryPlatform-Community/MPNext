/**
 * Interface for Congregation_Snapshot_Ministries
* Table: Congregation_Snapshot_Ministries
 * Access Level: ReadWriteAssignDelete
 * Special Permissions: DataExport, SecureRecord
 * Generated from column metadata
 */
export interface CongregationSnapshotMinistries {

  Congregation_Snapshot_Ministry_ID: number /* 32-bit integer */; // Primary Key
...
export type CongregationSnapshotMinistriesRecord = CongregationSnapshotMinistries;
