...
export const EventsSchema = z.object({
  ...
  RSVP_Confirmed_Message: z.string().max(2147483647).nullable(),
  ...
  PCO_Plan_ID: z.number().int().nullable(),
  PCO_Connect_Mode: z.number().int().nullable(),
  Show_On_Connect_Card: z.boolean(),
  Connect_Card_Order: z.number().int().nullable(),
  Online_Meeting_Link: z.string().max(2083).nullable(),
  Allow_Self_Checkin: z.boolean(),
  Event_Slot_Collection_ID: z.number().int().nullable(),
  ...
  Registration_Milestone: z.number().int().nullable(),
  Attendance_Milestone: z.number().int().nullable(),
  Allow_QR_Check_In: z.boolean(),
  QR_Redirect_Url: z.string().max(300).nullable(),
  Allow_Fastpass: z.boolean(),
  Medical_Release_Required: z.boolean(),
});
